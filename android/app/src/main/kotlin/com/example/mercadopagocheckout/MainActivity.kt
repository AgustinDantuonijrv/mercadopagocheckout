package com.example.mercadopagocheckout
...
class MainActivity: FlutterActivity() {
    ...
    private fun initFlutterChannels() {
        val channelMercadoPago = MethodChannel(flutterView, "com.example.mercadopagocheckout/proceso")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        val channelMercadoPagoRespuesta = MethodChannel(flutterView, "com.example.mercadopagocheckout/proceso")
